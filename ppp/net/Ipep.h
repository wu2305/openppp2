...
namespace ppp {
    namespace net {
        ...
        public:
            template<class TProtocol>       
            static bool                                                         GetAddressByHostName(const std::shared_ptr<boost::asio::ip::basic_resolver<TProtocol> >& resolver, const ppp::string& hostname, int port, const std::shared_ptr<GetAddressByHostNameCallback>& callback) noexcept {
                if (NULL == resolver) {
                    return false;
                }
            ...
            template<class TProtocol>       
            static bool                                                         GetAddressByHostName(boost::asio::ip::basic_resolver<TProtocol>& resolver, const ppp::string& hostname, int port, const std::shared_ptr<GetAddressByHostNameCallback>& callback) noexcept {
                if (NULL == callback) {
                    return false;
                }

                std::shared_ptr<GetAddressByHostNameCallback> callback_ = callback;
                return GetAddressesByHostName(resolver, hostname, port, make_shared_object<GetAddressesByHostNameCallback>(
            ...
            template<class TProtocol>       
            static bool                                                         GetAddressesByHostName(const std::shared_ptr<boost::asio::ip::basic_resolver<TProtocol> >& resolver, const ppp::string& hostname, int port, const std::shared_ptr<GetAddressesByHostNameCallback>& callback) noexcept {
                if (NULL == resolver) {
                    return false;
                }
            ...
            template<class TProtocol>       
            static bool                                                         GetAddressesByHostName(boost::asio::ip::basic_resolver<TProtocol>& resolver, const ppp::string& hostname, int port, const std::shared_ptr<GetAddressesByHostNameCallback>& callback) noexcept {
