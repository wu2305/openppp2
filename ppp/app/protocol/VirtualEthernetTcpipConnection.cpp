    ...
    namespace app {
        namespace protocol {
            ...
            bool VirtualEthernetTcpipConnection::ForwardSocketToTransmission(const std::shared_ptr<Byte>& buffer, int buffer_size, int bytes_transferred) noexcept {
                ...
                auto self = shared_from_this();
                auto evtf = make_shared_object<ppp::net::asio::IAsynchronousWriteIoQueue::AsynchronousWriteCallback>(
                ...
                return transmission->Write(buffer.get(), bytes_transferred, evtf);
            }
